...
async function SelectionSort() {
	...
	Finished_Sorting();
	alert("No of comparisions "+comparisions);
}
...
// QUICK SORT
// Partition(): This function is responsible for placing the element at index r in the array at its correct position in a way that 
//elements to the left of it are less than or equal to it, and elements to the right of it are greater than it. 
...
// HEAP SORT
// Heapfiy():  This function is a crucial part of the HeapSort algorithm. It takes an array of 
// elements, the length of the array (n), 
// and an index (i) as parameters. The goal of this function is to heapify the subtree rooted at the given index i.
